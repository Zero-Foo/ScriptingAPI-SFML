...
void Project::build()
{
    std::system(("cmake -G \"Visual Studio 17 2022\" -S ./"+name+" -B cmake -DCMAKE_TOOLCHAIN_FILE=\"C:\\vcpkg\\scripts\\buildsystems\\vcpkg.cmake\"").c_str());
    std::system("cmake --build cmake");
}
